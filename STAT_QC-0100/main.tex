...
$$\begin{array}{|c|c|c|} 
 ...
 \text{Angstrom} &\AA &0.0001\mu\text{m}\\
  \hline 
 \end{array}$$
...
\begin{center}
        \begin{tikzpicture}
\node[inner sep=0pt, anchor=base] (p1) at (0,0)
  {\includegraphics[height=50mm]{symmetric.jpg}};
           \end{tikzpicture}
      \end{center}
...
\begin{center}
        \begin{tikzpicture}
\node[inner sep=0pt, anchor=base] (p1) at (0,0)
  {\includegraphics[height=50mm]{skewedLeft.jpg}};
           \end{tikzpicture}
      \end{center}
...
\begin{center}
        \begin{tikzpicture}
\node[inner sep=0pt, anchor=base] (p1) at (0,0)
  {\includegraphics[height=50mm]{bimodal.jpg}};
           \end{tikzpicture}
      \end{center}
