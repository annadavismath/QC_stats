...
\begin{itemize}
    ...
    \item This histogram is skewed to the \wordChoice{\choice{left}[correct]\choice{right}\choice{center}}.  This behavior typically signals the presence of assignable causes of variation.  Such causes need to be identified and addressed.
