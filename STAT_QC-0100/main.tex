...
\node[inner sep=0pt, anchor=base] (p1) at (0,0)
  {\includegraphics[height=40mm]{screw.jpg}};
           \end{tikzpicture}
      \end{center}

If a part's measurement falls outside of the specification limits, the part is considered to be \emph{defective} or \emph{scrap}.  For example, we may order a batch of $50$ mm screws with specifications of $50$mm $\pm 5$mm.   Given these specs, a $52$mm screw is okay, but a $44$mm screw is scrap.
