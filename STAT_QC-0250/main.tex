...
\draw[line width=2pt](0,0)--(11,0)node[right=1mm]{CL} ;
 \draw[line width=1pt,red, dashed](0,3)--(11,3)node[right=1mm]{UCL};
\draw[line width=1pt,red, dashed](0,-3)--(11,-3)node[right=1mm]{LCL};
