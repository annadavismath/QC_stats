...
\href{https://www.qimacros.com/control-chart/stability-analysis-control-chart-rules/}{Nelson rules}
...
\draw[line width=2pt](0,0)--(11,0)node[below=5mm, left=0mm]{CL} ;
 \draw[line width=1pt,red, dashed](0,3)--(11,3)node[above=5mm, left=0mm]{UCL};
\draw[line width=1pt,red, dashed](0,-3)--(11,-3)node[below=5mm, left=0mm]{LCL};
