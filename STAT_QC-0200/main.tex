...
\begin{center}
         \begin{tikzpicture}
 \node[inner sep=0pt, anchor=base] (p1) at (0,0)
   {\includegraphics[height=80mm]{xBarChart.jpg}};
   \node[inner sep=0pt, anchor=base] (p2) at (12.5,0)
   {\includegraphics[height=80mm]{RChart.jpg}};
            \end{tikzpicture}
       \end{center}

% \begin{center}     
% \includegraphics{xBarChart.jpg}\quad\quad
% \includegraphics{RChart.jpg}
% \end{center}
