...
\begin{idea}
IF the process is under control, then there is essentially ZERO chance of us getting a sample such as sample 5.  Because such a sample did occur, we conclude that the process must be out of control, and must be paused.
\end{idea}
