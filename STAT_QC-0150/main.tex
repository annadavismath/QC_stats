...
\begin{question}\label{quest:qc150_2}
    ...
    \begin{multipleChoice}
        \choice[correct]{$\mu=12.85$, $\sigma= 0.07$}
        \choice{$\mu=12.85$, $\sigma= 0.1$}
...
\begin{selectAll}
\choice[correct]{The process is accurate}
\choice{The process is precise}
\choice[correct]{There is a lot of scrap}
\choice{The process meets the six-sigma quality standard}
\end{selectAll}
