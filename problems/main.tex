...
\begin{question}  
Do you give us permission to use the data from your session in our study?  Type YES or NO in the space below. (See \href{https://ximera.osu.edu/statproj/CLTtoHT/consent/main}{Consent Form} for more details.  
\begin{freeResponse}  
